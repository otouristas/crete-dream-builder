...
import type { ResidenceDetails } from "@/lib/residences-data";
...
export function ResidenceCard({ residence }: ResidenceCardProps) {
  ...
  return (
    <article className="group overflow-hidden rounded-sm border border-border bg-card shadow-soft transition-all duration-300 hover:shadow-warm">
      <div className="relative h-72 w-full overflow-hidden sm:h-80">
        ...
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between gap-2">
          <span className="rounded-xs bg-cream/95 px-3 py-1 text-xs font-semibold tracking-wide text-stone-deep shadow-xs backdrop-blur-xs">
            {residence.badge}
          </span>
        ...
        <div className="absolute bottom-4 left-4 right-4 text-cream">
          ...
          <ResidenceSpecs
            ...
            className="mt-2 text-xs font-medium text-cream/90"
          />
        </div>
      </div>
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="my-6 rounded-sm border border-border/60 bg-secondary/50 p-4">
          ...
          {isConcept1 ? (
            <div className="space-y-1 text-xs text-foreground/80">
              ...
              <div className="pt-1 text-[11px] text-muted-foreground">
                Rates vary by guest count (2 to 6). Minimum stay 2 nights.
              </div>
            </div>
          ) : (
            <div className="space-y-1 text-xs text-foreground/80">
              ...
              <div className="pt-1 text-[11px] text-muted-foreground">
                Flat rate for 1 to 7 guests. Minimum stay 3 nights.
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 border-t border-border pt-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-full border border-[#25D366]/40 bg-[#25D366]/10 px-4 py-2.5 text-xs font-medium text-[#17833f] transition-colors hover:bg-[#25D366]/20"
          >
