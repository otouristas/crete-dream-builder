...
export const SITE_HEADER_PT_CLASS =
  "pt-[calc(6.25rem+env(safe-area-inset-top,0px))] lg:pt-[calc(6.5rem+env(safe-area-inset-top,0px))]";
...
export const SITE_HERO_HEADER_PAD_CLASS =
  "pt-[calc(6.75rem+env(safe-area-inset-top,0px))] lg:pt-[calc(7.5rem+env(safe-area-inset-top,0px))]";
